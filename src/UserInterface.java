...
public class UserInterface {
    private static final ISearch isearch = new ISearch();
    private static final Scanner scanner = new Scanner(System.in);

    public static void mainMenu() {
        while (true) {
            System.out.println("-------------------------");
            System.out.println("ISearch Search Engine Menu");
            ...
            switch (scanner.next()) {
                ...
                case "2":
                    ...
                    if (isearchISearch.addDocuments(file)) {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    System.out.print(isearch.status());
                    break;
                case "5":
                    help();
                    break;
    ...
    private static void searchMenu() {
        ...
        // HashSet<File> documentsSet = isearch.simpleSearch(keyword);
        scanner.nextLine();
        String keywords = scanner.nextLine();
        HashSet<File> documentsSet = isearch.search(keywords);
        ...
        while (true) {
            ...
            switch (scanner.nextInt()) {
                case 1:
                    ...
                    HashMap<String, HashSet<File>> keywords = isearch.getKeywords();
                    ...
                    break;
                case 2:
                    HashSet<String> stopWords = isearch.getStopWords();
